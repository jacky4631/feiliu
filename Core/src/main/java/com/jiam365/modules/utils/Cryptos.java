...
public class Cryptos
{
    ...
    private static final String HAMCSHA256 = "HmacSHA256";
    ...
    {
        return hmacSha(input, key, "HmacSHA1");
    }

    public static byte[] hmacSha256(byte[] input, byte[] key)
    {
        return hmacSha(input, key, "HmacSHA256");
    }

    public static byte[] hmacSha(byte[] input, byte[] key, String hmacmode)
    {
        try
        {
