...
public class ZhuoWeiHandler extends AbstractHandler {

	private String MARK = "ZhuoWei";
	private static Logger logger = LoggerFactory.getLogger(ZhuoWeiHandler.class);
	...
	private ResponseData callback(String reqNo){
		...
		if (json != null) {
			ZhuoWeiReport rechargeReport = mapper.fromJson(json, ZhuoWeiReport.class);
	...
	public String getParamTemplate() {
		// TODO Auto-generated method stub
		return "{" + "\"rechargeUrl\":\"订购接口地址\"," + "\"queryUrl\":\"订购结果批查询地址\"," + "\"ec_code\":\"商户号\","
				+ "\"key\":\"秘钥\"" + "}";
	}
