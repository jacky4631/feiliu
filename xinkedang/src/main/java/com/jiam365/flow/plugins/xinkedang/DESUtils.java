...
public class DesUtils {
	...
	public static void main(String[] args) throws Exception {
		/** 加密、解密key. */
		final String PASSWORD_CRYPT_KEY = "kEHrDooxWHCWtfeSxvDvgqZq";

		String md5Password = "202cb962ac59075b964b07152d234b70";
		String str = DesUtils.encrypt(md5Password, PASSWORD_CRYPT_KEY);
		System.out.println("str: " + str);
		str = DesUtils.decrypt(str, PASSWORD_CRYPT_KEY);
		System.out.println("str: " + str);
	}
	 ...
	 */
	public final static String decrypt(String data, String pwd)
			throws Exception {
