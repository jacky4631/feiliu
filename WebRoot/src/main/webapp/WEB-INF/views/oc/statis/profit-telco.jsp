...
<div>
  ...
  <div id="page-wrapper" class="gray-bg">
    ...
    <tags:content_header icon="fa-file-text-o" sysname="${sysname}" title="利润表-按运营商"/>
...
<script type="text/javascript">
  $(function () {
    ...
    function loadContent() {
      $.ajax({
        url: "${ctx}/oc/statis/profit-telco-content",
        beforeSend: loading,
        data: {
