<%@ page import="com.jiam365.flow.server.dto.TProfitByTecol, com.jiam365.flow.server.utils.DoubleUtils, java.text.DecimalFormat, java.util.List" %>
<%@ page contentType="text/html;charset=UTF-8" %>
<%
  List<TProfitByTecol> profitByTelcoList = (List<TProfitByTecol>) request.getAttribute("profitByTelcoList");
  if (profitByTelcoList != null) {
    int idx = 0;
    DecimalFormat df = new DecimalFormat("#,##0.00");
    double totalAmount = 0, totalCost = 0, totalProfit = 0;

    for (TProfitByTecol profit : profitByTelcoList) {
    ...
    for (TProfitByTecol profit : profitByTelcoList) {
      ...
      out.println("<td>" + profit.getTelco().getName() + "</td>");
