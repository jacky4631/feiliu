...
<div>
  ...
  <div id="page-wrapper" class="gray-bg">
    ...
    <tags:content_header icon="fa-file-text-o" sysname="${sysname}" title="通道利润表"/>
...
<script type="text/javascript">
  $(function () {
    ...
    function loadContent() {
      $.ajax({
        url: "${ctx}/oc/statis/profit-channel-content",
        beforeSend: loading,
        data: {
