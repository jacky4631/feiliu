...
<div>
  ...
  <div id="page-wrapper" class="gray-bg">
    ...
    <tags:content_header icon="fa-search" sysname="${sysname}" title="流量充值记录"/>

    <div class="wrapper wrapper-content animated fadeInRight">
      <div class="ibox-content m-b-sm border-bottom">
        <form method="post" id="frm_filter" action="${ctx}/oc/tradelog/export">
          <div class="row">
            ...
            <div class="col-sm-2">
              <div class="input-group">
                <label class="control-label" for="filter_GED_timeConsuming">回调大于(小时)</label>
                <input type="text" class="form-control input-sm" name="filter_GED_timeConsuming" id="filter_GED_timeConsuming" placeholder="输入回调时间">
              </div>
            </div>
            <div class="col-sm-2">
              <div class="input-group">
            ...
            <div class="col-sm-2">
              <div class="input-group">
                <label class="control-label" for="filter_EQ_result">订单状态</label>
                <select name="filter_EQ_result" id="filter_EQ_result" class="form-control input-sm">
                  <option value="">全部</option>
                  <option value="9">充值中</option>
              ...
              <div class="btn-group" role="group">
                <div class="btn-group" role="group">
                  ...
                  <ul role="menu" class="dropdown-menu">
                    <li><a id="export" href="#">导出</a></li>
                    <li><a id="export2" href="#">导出上游对账单</a></li>
                  </ul>
                </div>
                <div class="btn-group">
                  ...
                  <ul role="menu" class="dropdown-menu">
                    ...
                    <li><a id="btn_report2" href="#"><i class="fa fa-envelope-o"></i>重推报告</a></li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      "ajax": {
        ...
        "data": function (d) {
          return $.extend({}, d, {
            ...
            "filter_GED_timeConsuming": $("#filter_GED_timeConsuming").val()
          });
        }
      },
      "columns": [
